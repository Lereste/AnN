...
class AuthController {
    ...
    public signUp = catchAsync(
        async (request: Request, response: Response, next: NextFunction) => {
            ...
            if (userExist) {
                throw new AppError(
                    "This email is already in use. Please use it to log in or select forgot password",
                    422
                );
            }
            ...
            this.authService.createSendToken(
                newUser,
                200,
                response,
    ...
    public logIn = catchAsync(
        async (
            ...
            const correctPassword = await this.authService.comparePassword(
                password,
                user.password
            );
    ...
    public updatePassword = catchAsync(
        async (request: any, response: Response, next: NextFunction) => {
            ...
            this.authService.createSendToken(
                ...
                200,
                response,
                "Update to new password successfully!"
            );
        }
    );
}
