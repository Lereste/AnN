...
import { CountryService } from 'src/app/core/service/country-service/country-service.service';
import { CheckoutForm, Cities, Districts, Wards } from 'src/app/core/models/checkout/checkout-form';
...
@Component({
  ...
  standalone: true,
  imports: [CartOrderSummaryComponent, NgxMatSelectSearchModule, NgFor, NgClass, CommonModule, FormsModule, MatFormFieldModule, MatInputModule, MatSelectModule, MatOptionModule, MatIconModule, ReactiveFormsModule, MatTableModule, NgSwitch, NgSwitchDefault, NgSwitchCase],
...
export class CheckOutComponent implements OnInit, AfterViewInit {
  ...
  protected filterCities() {
    ...
    this.filteredCities.next(
      this.cities.filter((city) => city.name_with_type.toLowerCase().indexOf(search) > -1)
    );
